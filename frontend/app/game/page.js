...
const STAGE_RULES_DATA = {
  1: {
    stageNumber: 1,
    title: "Stage 1: Pixel Detective",
    subtitle: "Real Camera Photography vs. Synthetic AI Generation",
    themeColor: "#38BDF8",
    badgeBg: "rgba(2, 132, 199, 0.2)",
    badgeBorder: "rgba(56, 189, 248, 0.45)",
    badgeText: "#38BDF8",
    chips: [
      { label: "⏱️ 40s per Visual", color: "#38BDF8" },
      { label: "🖼️ 10 Visuals", color: "#7DD3FC" },
      { label: "🏆 +10 / +8 / 0 Points", color: "#34D399" }
    ],
    overview: "Teams observe high-resolution imagery projected on the main auditorium screen for exactly 40 seconds per challenge. You must classify whether each visual is an authentic camera photograph or generated by an AI model, and optionally identify the specific generative model.",
    scoring: [
      {
        pts: "+10 PTS",
        label: "Full Accuracy Score",
        color: "#34D399",
        bg: "rgba(16, 185, 129, 0.12)",
        border: "rgba(16, 185, 129, 0.35)",
        desc: "Real image correctly identified, OR AI image correctly identified with the exact generator model name (e.g. Midjourney v6, Flux.1, DALL-E 3)."
      },
      {
        pts: "+8 PTS",
        label: "AI Classification Score",
        color: "#38BDF8",
        bg: "rgba(56, 189, 248, 0.1)",
        border: "rgba(56, 189, 248, 0.35)",
        desc: "AI image correctly identified as AI, but the generator model guess is incorrect or left blank."
      },
      {
        pts: "0 PTS",
        ...
        desc: "Wrong classification (e.g., AI image classified as Real Photo or vice versa). Auto-graded instantly by the engine."
      }
    ],
    checklist: [
      {
        icon: "👁️",
        title: "Iris Specular Reflection Symmetry",
        desc: "Real cameras capture matching reflections of ambient light in both pupils. AI generators frequently render divergent light sources or warped pupil geometry."
      },
      {
        icon: "🧬",
        title: "Subsurface Scattering & Skin Pores",
        desc: "Natural human skin diffuses light with dynamic ISO grain and pinkish translucent subsurface scattering. AI often produces airbrushed, plastic skin sheen."
      },
      {
        icon: "💇",
        title: "Hair Strands & Microtexturing",
        desc: "Real hair shows natural stray hairs, individual strands, and optical depth of field. AI frequently merges hair clumps into smoothed noodle-like textures."
      },
      {
        icon: "📷",
        title: "Lens Chromatic Aberration & Bokeh",
        desc: "Physical glass lenses produce subtle purple/green chromatic aberration on high-contrast edges. AI images often possess unnaturally sharp planar boundaries."
      }
    ],
    models: ["Midjourney v6", "Flux.1", "DALL-E 3", "Stable Diffusion XL (SDXL)", "Adobe Firefly", "Google Imagen 3"],
    conditions: [
      "Timer: Strictly 40 seconds per visual. Once the timer hits 00:00, submissions lock automatically.",
      "Input: Select 'Real' or 'AI'. If 'AI', select the generator model from the dropdown to qualify for full 10 points.",
      "Sync: Visuals appear simultaneously on the auditorium screen and sync directly to your player dashboard."
    ]
  },
  2: {
    stageNumber: 2,
    title: "Stage 2: The Glitch Hunt",
    subtitle: "Synthetic Artifact & Deepfake Forensics Investigation",
    themeColor: "#EF4444",
    badgeBg: "rgba(224, 27, 34, 0.2)",
    badgeBorder: "rgba(239, 68, 68, 0.45)",
    badgeText: "#FF7B7B",
    chips: [
      { label: "⏱️ 45s per Challenge", color: "#EF4444" },
      { label: "🔍 7 Anomaly Visuals", color: "#FCA5A5" },
      { label: "⚡ Descriptive Scoring", color: "#F97316" }
    ],
    overview: "While diffusion models generate visually stunning scenes, their neural spatial decoders frequently violate basic physics, geometry, and human anatomy. In this stage, 7 photorealistic visuals containing subtle glitches, inpainting, or deepfakes will be projected. Teams must spot and submit specific physical flaws before the 45s timer runs out.",
    scoring: [
      {
        pts: "ACCURACY",
        label: "Specific Flaw Identification",
        color: "#34D399",
        bg: "rgba(16, 185, 129, 0.12)",
        border: "rgba(16, 185, 129, 0.35)",
        desc: "Submissions that accurately locate and name the specific physical or anatomical glitch earn full points."
      },
      {
        pts: "PRECISION",
        label: "Descriptive Technical Language",
        color: "#F97316",
        bg: "rgba(249, 115, 22, 0.1)",
        border: "rgba(249, 115, 22, 0.35)",
        desc: "Technical precision matters (e.g. 'Shadow angle contradicts primary light source' vs vague 'Shadow looks bad')."
      },
      {
        pts: "SPEED",
        label: "Rapid-Fire Submission Bonus",
        color: "#38BDF8",
        bg: "rgba(56, 189, 248, 0.1)",
        border: "rgba(56, 189, 248, 0.35)",
        desc: "Teams submitting correct anomaly diagnoses earliest in the 45-second countdown hold tiebreaker advantages."
      }
    ],
    checklist: [
      {
        icon: "📐",
        title: "Physical & Optical Contradictions",
        desc: "Look for conflicting light vectors (shadows falling in opposite directions), impossible mirror reflections, floating objects with missing contact shadows, or warped horizon perspective lines."
      },
      {
        icon: "🖐️",
        title: "Biomechanical & Anatomical Glitches",
        desc: "Inspect hand digits (extra fingers, fused joints), asymmetric ear cartilage, distorted teeth incisors, irregular pupil geometry, or asymmetrical eyeglass frames."
      },
      {
        icon: "🪡",
        title: "Inpainting & Outpainting Seams",
        desc: "Digital inpainting creates localized compression mismatches (ELA), blurry boundary halos where elements were inserted, or repeating checkerboard transposed convolution artifacts."
      },
      {
        icon: "⚡",
        title: "Contextual Logic Failures",
        desc: "Objects merging unnaturally into backgrounds (e.g., a chair leg phasing into floorboards, clothing patterns suddenly changing direction)."
      }
    ],
    models: ["Deepfake Face Swaps", "Neural Inpainting", "Outpainting Boundaries", "Diffusion Latent Artifacts"],
    conditions: [
      "Timer: 45 seconds per image challenge. Clock turns red under 10 seconds.",
      "Format: Type a concise, descriptive explanation of the observed glitch into the answer terminal.",
      "Teamwork: One teammate should focus on background perspective while another scrutinizes facial and hand anatomy."
    ]
  },
  3: {
    stageNumber: 3,
    title: "Stage 3: Prompt Wars",
    subtitle: "Championship Grand Finale • Reverse Semantic Prompt Deduction",
    themeColor: "#F97316",
    badgeBg: "rgba(249, 115, 22, 0.2)",
    badgeBorder: "rgba(249, 115, 22, 0.45)",
    badgeText: "#FED7AA",
    chips: [
      { label: "⏱️ 75s per Showdown", color: "#F97316" },
      { label: "👑 5 Grand Duels", color: "#FBBF24" },
      { label: "🔬 CLIP Vector Scoring", color: "#38BDF8" }
    ],
    overview: "The grand finale championship! The top qualifying squads enter the ultimate reverse engineering arena. High-concept AI artwork is revealed progressively on the main screen. Teams must deduce and reconstruct the exact generative prompt, keywords, and artistic parameters used to create the image.",
    scoring: [
      {
        pts: "COSINE",
        label: "CLIP Semantic Similarity",
        color: "#38BDF8",
        bg: "rgba(56, 189, 248, 0.12)",
        border: "rgba(56, 189, 248, 0.35)",
        desc: "The tournament engine vectorizes your prompt using OpenAI CLIP embeddings: Cosine Similarity = (A · B) / (||A|| ||B||). Higher semantic alignment yields higher scores."
      },
      {
        pts: "BONUS",
        label: "Progressive Resolution Multiplier",
        color: "#34D399",
        bg: "rgba(16, 185, 129, 0.1)",
        border: "rgba(16, 185, 129, 0.35)",
        desc: "Visuals start blurred and progressively resolve over the 75-second countdown. Submissions locked during earlier resolution phases receive substantial bonus multipliers!"
      },
      {
        pts: "PODIUM",
        ...
        desc: "Overall tournament podium positions and awards are decided based on cumulative points after Round 3."
      }
    ],
    checklist: [
      {
        icon: "🎭",
        title: "Subject, Character & Action Semantics",
        desc: "Identify the primary subject, character archetype, pose, emotional expression, and physical actions with precise nouns and verbs."
      },
      {
        icon: "🎨",
        title: "Artistic Medium, Engine & Style",
        desc: "Deduce the medium: '35mm vintage photograph', 'oil on canvas', 'matte painting', 'octane render', 'unreal engine 5 cinematic', or 'cyberpunk concept art'."
      },
      {
        icon: "💡",
        title: "Lighting Vectors & Atmospheric Mood",
        desc: "Include specific lighting tokens: 'volumetric god rays', 'cinematic rim lighting', 'golden hour', 'chiaroscuro', 'neon bloom', or 'foggy morning diffusion'."
      },
      {
        icon: "📷",
        title: "Optics, Focal Length & Composition",
        desc: "Specify camera composition tokens: '85mm portrait f/1.4 lens', 'macro extreme close-up', 'wide-angle low perspective', 'kodachrome film grain', or 'bokeh'."
      }
    ],
    models: ["CLIP ViT-B/32", "High-Dimensional Vector Cosine Similarity", "Progressive Unblur Phases"],
    conditions: [
      "Timer: Strictly 75 seconds per showdown.",
      "Token Precision: Avoid spamming 50 meaningless buzzwords—CLIP measures semantic distance. Precise descriptive tags score vastly higher than keyword dumping.",
      "Speed Strategy: Submit your initial draft early to lock the progressive resolution multiplier, or refine keywords for maximum cosine match."
    ]
  }
}
...
export default function GameArena() {
  ...
  const [waitingStageTab, setWaitingStageTab] = useState(null)
  ...
  // Live input & submission lock refs to completely eliminate stale closures
  const textSubmissionRef = useRef('')
  const round1AnswerRef = useRef({ chosen: '', bonus: '' })
  const submittedRef = useRef(false)
  const isSubmittingRef = useRef(false)
  const gameStateRef = useRef(gameState)
  const activeQuestionIdRef = useRef(gameState.activeQuestionId)

  useEffect(() => {
    textSubmissionRef.current = textSubmission
  }, [textSubmission])

  useEffect(() => {
    round1AnswerRef.current = round1Answer
  }, [round1Answer])
  ...
  const prelimAnswersRef = useRef({})
  useEffect(() => {
    prelimAnswersRef.current = prelimAnswers
  }, [prelimAnswers])
  ...
  // Centralized submission & auto-lock system (Zero Stale Closures)
  const submitAnswerLockedIn = async (reason = 'MANUAL') => {
    if (submittedRef.current || isSubmittingRef.current) {
      console.log(`[Submission] Skipped (${reason}): already submitted or in-flight`)
      return
    }

    const currentGState = gameStateRef.current
    const activeQId = currentGState?.activeQuestionId
    if (!activeQId) {
      console.log(`[Submission] Skipped (${reason}): no active question ID`)
      return
    }

    const isRound1 = currentGState.activeRound === 2 || currentGState.activeRound === 1
    const curRound1 = round1AnswerRef.current || { chosen: '', bonus: '' }
    const curText = (textSubmissionRef.current || '').trim()

    // For Round 1 (Pixel Detective): if user didn't choose Real or AI
    if (isRound1 && !curRound1.chosen) {
    ...
    // Immediately mark as submitted and lock in UI so user has instant feedback
    ...
    const payload = {
      ...
      chosenAnswer: isRound1 ? curRound1.chosen : '',
      bonusAnswer: isRound1 ? curRound1.bonus : '',
      textSubmission: isRound1 ? '' : (curText || '[No response submitted within time limit]')
    }

    console.log(`[Submission] Locking in response (${reason}) for Question #${activeQId}:`, payload)
    ...
    try {
      ...
      if (res.ok) {
        console.log(`[Submission] Successfully saved to backend! (${reason})`)
        fetchTeamProfile(authToken)
      } else {
        const text = await res.text()
        try {
          const data = JSON.parse(text)
          if (data.message && data.message.includes('already submitted')) {
            console.log('[Submission] Already saved in database.')
          } else {
  ...
  const handleSubmitAnswer = (e) => {
    ...
    submitAnswerLockedIn('MANUAL')
  }

  const triggerAutoSubmit = () => {
    submitAnswerLockedIn('AUTO_TIMER')
  }
    ...
    if (gameState.activeQuestionId) {
      ...
      if (q) {
        ...
        if (lastQuestionIdRef.current !== gameState.activeQuestionId) {
          // If previous question was active and had unsubmitted typed text, lock it before switching!
          if (lastQuestionIdRef.current && !submittedRef.current && textSubmissionRef.current?.trim()) {
            submitAnswerLockedIn('AUTO_QUESTION_TRANSITION')
          }
          lastQuestionIdRef.current = gameState.activeQuestionId

          // Check if team already submitted for this question
          const existingSub = team?.submissions?.find(s => s.questionId === gameState.activeQuestionId)
          if (existingSub) {
            setSubmitted(true)
            submittedRef.current = true
            setTextSubmission(existingSub.textSubmission || '')
            textSubmissionRef.current = existingSub.textSubmission || ''
            setRound1Answer({ chosen: existingSub.chosenAnswer || '', bonus: existingSub.bonusAnswer || '' })
            round1AnswerRef.current = { chosen: existingSub.chosenAnswer || '', bonus: existingSub.bonusAnswer || '' }
          } else {
            setSubmitted(false) // reset submission flag only when question actually changes
            submittedRef.current = false
            setSubmitError('')
            setRound1Answer({ chosen: '', bonus: '' })
            round1AnswerRef.current = { chosen: '', bonus: '' }
            setTextSubmission('')
  ...
  }, [gameState.activeQuestionId, questions, token, team])
    ...
    if (gameState.timerRunning && localEndTime > 0) {
      interval = setInterval(() => {
        ...
        if (remaining <= 0) {
          ...
          if (!submittedRef.current && activeQuestionIdRef.current) {
            console.log('[Timer] Expired! Auto-locking submission...')
            submitAnswerLockedIn('AUTO_TIMER')
          }
        } else {
  ...
  }, [gameState.timerRunning, localEndTime])
  ...
  const fetchTeamProfile = async (tok) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Check if current active question is already submitted by this team
        const currentQId = gameStateRef.current?.activeQuestionId
        if (profile.submissions && currentQId) {
          const existingSub = profile.submissions.find(s => s.questionId === currentQId)
          if (existingSub) {
            setSubmitted(true)
            submittedRef.current = true
            if (existingSub.textSubmission) {
              setTextSubmission(existingSub.textSubmission)
              textSubmissionRef.current = existingSub.textSubmission
            }
            if (existingSub.chosenAnswer) {
              setRound1Answer({ chosen: existingSub.chosenAnswer, bonus: existingSub.bonusAnswer || '' })
              round1AnswerRef.current = { chosen: existingSub.chosenAnswer, bonus: existingSub.bonusAnswer || '' }
            }
          }
    ...
    const setupWebSocket = () => {
      ...
      ws.onmessage = (event) => {
        ...
        if (message.type === 'GAME_STATE') {
          const newGState = message.payload
          // If timer was running and has now stopped, or active question is ending, auto-lock unsubmitted input!
          if (gameStateRef.current?.timerRunning && !newGState.timerRunning && !submittedRef.current && gameStateRef.current?.activeQuestionId) {
            console.log('[WS] Timer stopped by admin! Auto-locking submission...')
            submitAnswerLockedIn('AUTO_TIMER_STOPPED')
          }
          setGameState(newGState)
  ...
  const handlePrelimSubmit = async () => {
    ...
    stopWebcam()
    const answersToSend = prelimAnswersRef.current || prelimAnswers
    try {
      const res = await fetch(`${API_BASE_URL}/api/game/prelims/submit`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${token}` },
        body: JSON.stringify({ participantName, answers: answersToSend })
      })
      if (res.ok) {
        const attempt = await res.json()
        setMyAttempt(attempt)
          ...
          <div style={{ maxWidth: (gameState.activeRound >= 1 && gameState.activeRound <= 4) ? '1560px' : '1100px', margin: '0 auto', width: '100%', transition: 'max-width 0.3s ease' }}>
            ...
            {gameState.activeRound === 0 && (
              <div className="glass-panel" style={{ padding: '44px 32px', textAlign: 'center', marginTop: '30px' }}>
                ...
                <h2 style={{ fontSize: '2rem', marginBottom: '12px', textTransform: 'uppercase', letterSpacing: '1px', color: '#FFF' }}>
                ...
                <div className="shimmer-bg" style={{ padding: '14px 24px', borderRadius: '8px', display: 'inline-block', border: '1px solid var(--card-border)' }}>
                  ...
                  <div style={{ fontWeight: '700', color: 'var(--color-neon-blue)', marginTop: '4px', fontSize: '0.95rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '2px' }}>
                    <span>The event is going to start soon</span>
                    ...
                    <div>
                      ...
                      <div className="stage-briefing-box">
                        ...
                        <ul style={{ margin: 0, paddingLeft: '18px', color: 'var(--text-secondary)', fontSize: '0.88rem', lineHeight: '1.6' }}>
                          ...
                          <li><strong>Integrity Protocol:</strong> Strict randomized question delivery and anti-cheat checks operate during the exam.</li>
                        </ul>
                      </div>
              ...
              <div>
                {!gameState.activeQuestionId ? (
                  <div style={{ marginTop: '30px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
                    {/* Main Stage Waiting Screen Header (As Displayed on Auditorium Display) */}
                    <div className="glass-panel" style={{ padding: '42px 32px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
                      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '3px', background: 'linear-gradient(90deg, #38BDF8 0%, #E01B22 50%, #F97316 100%)' }} />
                      <div className="float-bounce" style={{ width: '74px', height: '74px', borderRadius: '50%', background: 'rgba(224, 27, 34, 0.14)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px', border: '2px solid rgba(224, 27, 34, 0.45)', boxShadow: '0 0 24px rgba(224, 27, 34, 0.3)' }}>
                        <span style={{ fontSize: '2rem' }}>📡</span>
                      </div>
                      <h2 style={{ fontSize: '1.75rem', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '1.5px', fontFamily: 'var(--font-display)' }}>
                      ...
                      <div className="shimmer-bg" style={{ padding: '10px 24px', borderRadius: '24px', display: 'inline-flex', alignItems: 'center', gap: '8px', border: '1px solid var(--card-border)', marginTop: '22px' }}>
                        <span className="live-pulse-dot" style={{ width: '7px', height: '7px', background: 'var(--color-neon-blue)', borderRadius: '50%' }} />
                        <span className="typing-cursor" style={{ fontSize: '0.84rem', color: 'var(--color-neon-blue)', fontWeight: 'bold', letterSpacing: '0.5px' }}>
                          Awaiting Next Neural Transmission!
                        </span>
                      </div>
                    </div>

                    {/* Stage Rules & Conditions Briefing Card */}
                    {(() => {
                      const activeStageNum = gameState.activeRound === 2 ? 1 : gameState.activeRound === 3 ? 2 : gameState.activeRound === 4 ? 3 : 1
                      const currentTabNum = waitingStageTab || activeStageNum
                      const stageInfo = STAGE_RULES_DATA[currentTabNum] || STAGE_RULES_DATA[1]

                      return (
                        <div className="glass-panel" style={{ padding: '32px 28px', border: `1.5px solid ${stageInfo.badgeBorder}`, boxShadow: `0 8px 32px rgba(0,0,0,0.55), 0 0 20px ${stageInfo.badgeBg}` }}>
                          {/* Briefing Top Bar */}
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '14px', marginBottom: '24px', borderBottom: '1px solid rgba(255,255,255,0.08)', paddingBottom: '18px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                              <span style={{ fontSize: '1.4rem' }}>📋</span>
                              <div>
                                <h3 style={{ fontSize: '1.25rem', textTransform: 'uppercase', letterSpacing: '1px', margin: 0, color: '#FFF' }}>
                                  Round Intelligence • Rules &amp; Conditions
                                </h3>
                                <div style={{ fontSize: '0.78rem', color: 'var(--text-secondary)', marginTop: '2px' }}>
                                  Review official tournament rules, scoring matrices, and optical forensic criteria
                                </div>
                              </div>
                            </div>

                            {/* Stage Switcher Tabs */}
                            <div style={{ display: 'inline-flex', gap: '8px', background: 'rgba(0,0,0,0.4)', padding: '5px', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.08)', flexWrap: 'wrap' }}>
                              {[1, 2, 3].map((stageNum) => {
                                const isSelected = currentTabNum === stageNum
                                const isCurrentActiveRound = activeStageNum === stageNum
                                const data = STAGE_RULES_DATA[stageNum]
                                return (
                                  <button
                                    key={stageNum}
                                    type="button"
                                    onClick={() => setWaitingStageTab(stageNum)}
                                    style={{
                                      background: isSelected ? data.badgeBg : 'transparent',
                                      border: isSelected ? `1.5px solid ${data.themeColor}` : '1px solid transparent',
                                  ...
                                  >
                                    <span>{stageNum === 1 ? '🎯' : stageNum === 2 ? '🔍' : '👑'}</span>
                                    <span>Stage {stageNum}</span>
                                    {isCurrentActiveRound && (
                                      <span style={{ fontSize: '0.62rem', background: '#22C55E', color: '#000', padding: '1px 5px', borderRadius: '4px', fontWeight: '900', letterSpacing: '0.5px' }}>
                                        ACTIVE
                                      </span>
                                    )}
                                  </button>
                          ...
                          {/* Active Stage Header Row */}
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '16px', marginBottom: '20px' }}>
                            <div>
                              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                                <span style={{ background: stageInfo.themeColor, color: '#000', padding: '3px 10px', borderRadius: '4px', fontSize: '0.72rem', fontWeight: '900', letterSpacing: '1px', textTransform: 'uppercase' }}>
                                  STAGE {stageInfo.stageNumber} SPECIFICATION
                                </span>
                                {activeStageNum === stageInfo.stageNumber && (
                                  <span style={{ background: 'rgba(34, 197, 94, 0.15)', border: '1px solid #22C55E', color: '#86EFAC', padding: '2px 8px', borderRadius: '4px', fontSize: '0.7rem', fontWeight: 'bold' }}>
                                    ● Current Arena Stage
                                  </span>
                                )}
                              </div>
                              <h3 style={{ fontSize: '1.55rem', textTransform: 'uppercase', letterSpacing: '1px', color: '#FFF', margin: '0 0 4px 0' }}>
                                {stageInfo.title}
                              </h3>
                              <p style={{ color: stageInfo.themeColor, fontSize: '0.88rem', fontWeight: '600', margin: 0 }}>
                                {stageInfo.subtitle}
                              </p>
                            </div>
                          ...
                          {/* Challenge Objective Paragraph */}
                          <div style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.07)', borderRadius: '10px', padding: '16px 20px', marginBottom: '24px', lineHeight: '1.65', color: 'var(--text-secondary)', fontSize: '0.92rem' }}>
                            <strong style={{ color: '#FFF' }}>🎯 Challenge Objective: </strong>
                            {stageInfo.overview}
                          </div>

                          {/* Scoring Matrix Cards */}
                          <div style={{ marginBottom: '26px' }}>
                            <div style={{ fontSize: '0.8rem', color: stageInfo.themeColor, fontWeight: '800', letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                              <span>📊</span>
                              <span>Scoring Matrix &amp; Evaluation Formula</span>
                            </div>
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '14px' }}>
                              {stageInfo.scoring.map((s, idx) => (
                                <div
                                  key={idx}
                                  style={{
                                    background: s.bg,
                                ...
                                >
                                  <div>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                                      <span style={{ fontSize: '1.15rem', fontWeight: '900', color: s.color, fontFamily: 'var(--font-display)' }}>
                                        {s.pts}
                                      </span>
                                      <span style={{ fontSize: '0.72rem', color: '#FFF', background: 'rgba(0,0,0,0.4)', padding: '2px 8px', borderRadius: '4px', fontWeight: '700' }}>
                                        {s.label}
                                      </span>
                                    </div>
                          ...
                          {/* Forensic Checklist Cards */}
                          <div style={{ marginBottom: '26px' }}>
                            <div style={{ fontSize: '0.8rem', color: stageInfo.themeColor, fontWeight: '800', letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                              <span>🔬</span>
                              <span>Tactical Inspection Checklist • What To Look For</span>
                            </div>
                          ...
                          {/* Generator Models & Architecture Tags */}
                          {stageInfo.models && (
                            <div style={{ marginBottom: '24px', background: 'rgba(0,0,0,0.3)', padding: '14px 18px', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.06)' }}>
                              <span style={{ fontSize: '0.78rem', color: 'var(--text-secondary)', fontWeight: '700', marginRight: '10px' }}>
                                Key Architectures to Recognize:
                              </span>
                              <div style={{ display: 'inline-flex', gap: '8px', flexWrap: 'wrap', marginTop: '4px' }}>
                                {stageInfo.models.map((mod, idx) => (
                                  <span
                                    key={idx}
                                    style={{
                                      background: 'rgba(255,255,255,0.05)',
                          ...
                          {/* Conditions and Guidelines Callout Box */}
                          <div style={{ background: 'rgba(255, 255, 255, 0.025)', borderLeft: `4px solid ${stageInfo.themeColor}`, borderRadius: '8px', padding: '14px 18px' }}>
                            <div style={{ fontWeight: 'bold', fontSize: '0.86rem', color: '#FFF', marginBottom: '6px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                              <span>⚡</span>
                              <span>Mandatory Round Protocols &amp; Anti-Cheat Conditions:</span>
                            </div>
                            <ul style={{ margin: 0, paddingLeft: '20px', fontSize: '0.82rem', color: 'var(--text-secondary)', lineHeight: '1.6' }}>
                              {stageInfo.conditions.map((cond, idx) => (
                  ...
                  <div style={{ marginTop: '20px' }}>
                    ...
                    <div className="player-arena-layout">
                      ...
                      <div className="player-main-workspace">
                        ...
                        {submitted ? (
                          <div className="glass-panel" style={{ padding: '36px', textAlign: 'center', border: '1px solid rgba(56, 189, 248, 0.4)' }}>
                            <div className="lock-in-pulse" style={{ width: '80px', height: '80px', borderRadius: '50%', background: 'rgba(56, 189, 248, 0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px', border: '2px solid var(--color-primary-blue)' }}>
                            ...
                            <h3 className="scale-pop" style={{ textTransform: 'uppercase', letterSpacing: '1px', color: '#FFF', fontSize: '1.3rem' }}>
                              🔒 Response Locked In
                            </h3>
                            <p style={{ color: 'var(--text-secondary)', fontSize: '0.92rem', marginTop: '6px', maxWidth: '480px', margin: '6px auto 0' }}>
                              Your telemetry has been encrypted and submitted to the tournament engine.
                            </p>

                            {/* Detailed Confirmed Locked Response Card */}
                            <div style={{
                              marginTop: '22px',
                              ...
                              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                                <span style={{ fontSize: '0.75rem', color: '#38BDF8', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '1px' }}>
                                  {gameState.activeRound === 2 && '📷 Forensic Classification'}
                                  {gameState.activeRound === 3 && '🎯 Forensic Glitch Report'}
                                  {gameState.activeRound === 4 && '📜 Generative Prompt Deduction'}
                                </span>
                                <span style={{ fontSize: '0.72rem', color: '#34D399', background: 'rgba(52,211,153,0.12)', border: '1px solid rgba(52,211,153,0.35)', padding: '2px 8px', borderRadius: '4px', fontWeight: 'bold' }}>
                                  ✓ SAVED &amp; LOCKED
                                </span>
                              </div>
                              ...
                              {gameState.activeRound === 2 ? (
                                <div style={{ fontSize: '0.95rem', color: '#FFF' }}>
                                  Classification: <strong style={{ color: round1Answer.chosen === 'AI' ? '#EF4444' : '#34D399' }}>{round1Answer.chosen === 'AI' ? '🤖 Synthetic AI' : '📷 Authentic Photo'}</strong>
                                  {round1Answer.bonus && (
                                    <span style={{ marginLeft: '12px', color: '#38BDF8' }}>
                                      Model: <strong>{round1Answer.bonus}</strong>
                                    </span>
                                  )}
                                </div>
                              ) : (
                                <div style={{
                                  fontSize: '0.92rem',
                                  color: textSubmission ? '#E2E8F0' : '#94A3B8',
                                  fontStyle: textSubmission ? 'normal' : 'italic',
                                  lineHeight: 1.5,
                                  whiteSpace: 'pre-wrap',
                                  ...
                                  {textSubmission || '[No text submitted within time limit]'}
                                </div>
                              )}
                            </div>
                          </div>
                          ...
                          <div className="glass-panel" style={{ padding: '32px' }}>
                            ...
                            <form onSubmit={handleSubmitAnswer}>
                                ...
                                <div>
                                  ...
                                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
                                    <button
                                      ...
                                      onClick={() => {
                                        const updated = { ...round1Answer, chosen: 'REAL' }
                                        setRound1Answer(updated)
                                        round1AnswerRef.current = updated
                                      }}
                                    >
                                    ...
                                    <button
                                      ...
                                      onClick={() => {
                                        const updated = { ...round1Answer, chosen: 'AI' }
                                        setRound1Answer(updated)
                                        round1AnswerRef.current = updated
                                      ...
                                      <div className="model-grid">
                                        {[
                                          ...
                                          <button
                                            ...
                                            onClick={() => {
                                              const updated = { ...round1Answer, bonus: m.name }
                                              setRound1Answer(updated)
                                              round1AnswerRef.current = updated
                                            }}
                                          >
                                  ...
                                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginBottom: '12px' }}>
                                    ...
                                    {[
                                      ...
                                      <button
                                        ...
                                        onClick={() => {
                                          const prev = textSubmissionRef.current || ''
                                          const nextVal = prev ? `${prev}, ${tag}` : tag
                                          setTextSubmission(nextVal)
                                          textSubmissionRef.current = nextVal
                                        }}
                                      >
                                        + {tag}
                                      </button>
                                  ...
                                  <div className="cyber-terminal-container">
                                    ...
                                    <textarea
                                      ...
                                      onChange={(e) => {
                                        ...
                                        setTextSubmission(val)
                                        textSubmissionRef.current = val
                                      }}
                                  ...
                                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginBottom: '12px' }}>
                                    ...
                                    {[
                                      ...
                                      <button
                                        ...
                                        onClick={() => {
                                          const prev = textSubmissionRef.current || ''
                                          const nextVal = prev ? `${prev}, ${token}` : token
                                          setTextSubmission(nextVal)
                                          textSubmissionRef.current = nextVal
                                        }}
                                      >
                              ...
                              <button
                                type="submit"
                                className="btn-primary"
                                style={{ width: '100%', marginTop: '20px', padding: '14px', fontSize: '1.02rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}
                                disabled={isSubmittingRef.current || (gameState.activeRound === 2 && !round1Answer.chosen)}
                              >
          ...
          <div className="acknowledge-modal-container">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '22px', fontSize: '0.88rem', color: 'var(--text-secondary)', lineHeight: '1.5' }}>
              ...
              <div className="acknowledge-rule-card" style={{ borderLeft: '3.5px solid #F97316', animation: 'ruleCardSlideIn 0.35s ease-out 0.24s both' }}>
                <strong style={{ color: '#F97316', display: 'block', marginBottom: '2px', fontSize: '0.92rem' }}>🛡️ Academic Integrity Protocol</strong>
                All questions and answers are randomized per participant and verified on the server in real-time. Tab-switching is tracked.
              </div>
            </div>
            ...
            <label className={`acknowledge-consent-box ${hasAcknowledged ? 'consented' : 'unconsented'}`} style={{ marginBottom: '24px' }}>
              ...
              <span style={{ fontSize: '0.88rem', color: '#FFF', lineHeight: '1.5' }}>
                I have read and acknowledge the tournament context: <strong>30 questions in 30 minutes</strong> and the <strong>-5 penalty for wrong answers</strong>.
              </span>
            </label>
