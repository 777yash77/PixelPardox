...
const STAGE_RULES_DATA = {
  1: {
    ...
    badgeText: "#38BDF8",
    chips: [
      { label: "⏱️ 48s per Visual", color: "#38BDF8" },
      { label: "🖼️ 10 Visuals", color: "#7DD3FC" },
      { label: "🏆 +10 / +8 / 0 Points", color: "#34D399" }
    ],
    overview: "Teams observe high-resolution imagery projected on the main auditorium screen for exactly 48 seconds per challenge. You must classify whether each visual is an authentic camera photograph or generated by an AI model, and optionally identify the specific generative model.",
    scoring: [
      {
        pts: "+10 PTS",
    ...
    conditions: [
      "Timer: Strictly 48 seconds per visual. Once the timer hits 00:00, submissions lock automatically.",
  ...
  2: {
    ...
    badgeText: "#FF7B7B",
    chips: [
      { label: "⏱️ 60s per Challenge", color: "#EF4444" },
      { label: "🔍 6 Anomaly Visuals", color: "#FCA5A5" },
      { label: "⚡ Descriptive Scoring", color: "#F97316" }
    ],
    overview: "While diffusion models generate visually stunning scenes, their neural spatial decoders frequently violate basic physics, geometry, and human anatomy. In this stage, 6 photorealistic visuals containing subtle glitches, inpainting, or deepfakes will be projected. Teams must spot and submit specific physical flaws before the 60s timer runs out.",
    scoring: [
      {
        pts: "ACCURACY",
      ...
      },
      {
        ...
        bg: "rgba(56, 189, 248, 0.1)",
        border: "rgba(56, 189, 248, 0.35)",
        desc: "Teams submitting correct anomaly diagnoses earliest in the 60-second countdown hold tiebreaker advantages."
      }
    ],
    checklist: [
      {
    ...
    conditions: [
      "Timer: 60 seconds per image challenge. Clock turns red under 10 seconds.",
  ...
  3: {
    ...
    badgeText: "#FED7AA",
    chips: [
      { label: "⏱️ 78s per Showdown", color: "#F97316" },
    ...
    scoring: [
      ...
      },
      {
        ...
        border: "rgba(16, 185, 129, 0.35)",
        desc: "Visuals start blurred and progressively resolve over the 78-second countdown. Submissions locked during earlier resolution phases receive substantial bonus multipliers!"
      },
      {
        pts: "PODIUM",
    ...
    conditions: [
      "Timer: Strictly 78 seconds per showdown.",
