...
export default function Register() {
  ...
  return (
    <div style={{
      ...
      {/* Spider-Web Corner Accents (Red Theme) */}
      ...
      <div className="auth-command-wrapper">
        <div className="auth-command-grid">
          ...
          {/* LEFT COLUMN: SQUAD COMMISSIONING INTELLIGENCE */}
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                <div className="auth-briefing-item">
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
                    ...
                    <span style={{ fontSize: '0.9rem', fontWeight: 800, color: '#FF7B7B', letterSpacing: '0.5px' }}>SQUAD FORMATION FORMAT</span>
                    <span style={{ marginLeft: 'auto', background: 'rgba(224, 27, 34, 0.25)', border: '1px solid rgba(224, 27, 34, 0.4)', borderRadius: '4px', padding: '2px 8px', fontSize: '0.72rem', color: '#FFF', fontWeight: 700 }}>2 - 4 PILOTS</span>
                  </div>
                  <p style={{ fontSize: '0.84rem', color: 'var(--text-secondary)', margin: 0, lineHeight: 1.45 }}>
                    Form a Duo, Trio, or Quad unit. Each pilot logs into the arena portal using your squad credentials and specifies their personal operative handle.
                  </p>
                </div>
                ...
                <div className="auth-briefing-item">
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
                    <span style={{ fontSize: '1.15rem' }}>⚡</span>
                    <span style={{ fontSize: '0.9rem', fontWeight: 800, color: '#FF7B7B', letterSpacing: '0.5px' }}>COLLECTIVE AGGREGATION</span>
                    <span style={{ marginLeft: 'auto', background: 'rgba(224, 27, 34, 0.25)', border: '1px solid rgba(224, 27, 34, 0.4)', borderRadius: '4px', padding: '2px 8px', fontSize: '0.72rem', color: '#FFF', fontWeight: 700 }}>AVERAGE SCORE</span>
                  </div>
                  <p style={{ fontSize: '0.84rem', color: 'var(--text-secondary)', margin: 0, lineHeight: 1.45 }}>
                    Your qualifying position is determined by averaging the points earned by all squad members. Assemble teammates with complementary forensic skills!
                  </p>
                </div>
                ...
                <div className="auth-briefing-item">
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
                    ...
                    <span style={{ fontSize: '0.9rem', fontWeight: 800, color: '#FF7B7B', letterSpacing: '0.5px' }}>MULTIVERSE TOURNAMENT PATH</span>
                    <span style={{ marginLeft: 'auto', background: 'rgba(224, 27, 34, 0.25)', border: '1px solid rgba(224, 27, 34, 0.4)', borderRadius: '4px', padding: '2px 8px', fontSize: '0.72rem', color: '#FFF', fontWeight: 700 }}>4 ROUNDS</span>
                  </div>
                  <p style={{ fontSize: '0.84rem', color: 'var(--text-secondary)', margin: 0, lineHeight: 1.45 }}>
                    Survive Stage 0 Prelims to unlock Stage 1 Pixel Detective, Stage 2 Audio Deepfake Matrix, and the Final Multiverse Showdown.
                  </p>
                </div>
              </div>
            </div>
