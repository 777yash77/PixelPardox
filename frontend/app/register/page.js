  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (sizeNum < 1 || sizeNum > 2) {
        setError('Team size must be strictly 1 or 2 members.')
        setLoading(false)
        return
      }
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(230px, 1fr))', gap: '14px' }}>
                <div className="auth-briefing-item">
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
                    ...
                    <span style={{ marginLeft: 'auto', background: 'rgba(56, 189, 248, 0.2)', border: '1px solid rgba(56, 189, 248, 0.45)', borderRadius: '4px', padding: '2px 8px', fontSize: '0.7rem', color: '#FFF', fontWeight: 700 }}>1 - 2 MEMBERS</span>
                  </div>
                  <p style={{ fontSize: '0.82rem', color: 'var(--text-secondary)', margin: 0, lineHeight: 1.45 }}>
                    Form a Solo or Duo unit. Each team member logs into the portal using team credentials and selects their member name.
                  </p>
                </div>
              ...
              <div className="auth-guidelines-container">
                ...
                <div className="auth-guidelines-list">
                  ...
                  <div className="auth-guideline-card">
                    ...
                    <div className="auth-guideline-body">
                      <div className="auth-guideline-title">
                        <span>Strict Squad Size (1 - 2 Members)</span>
                        <span className="auth-guideline-tag">ROSTER LOCK</span>
                      </div>
                      <p className="auth-guideline-desc">
                        Configure either a <strong>Solo Operative (1 member)</strong> or <strong>Duo Strike (2 members)</strong>. Verify all participant names carefully—squad rosters lock permanently upon registration and cannot be modified.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="auth-guideline-card">
                    ...
                    <div className="auth-guideline-body">
                      <div className="auth-guideline-title">
                        ...
                        <span className="auth-guideline-tag">ANTI-CHEAT</span>
                      </div>
                      <p className="auth-guideline-desc">
                        Stage 0 Prelims enforces <strong>anti-cheat protocols</strong>. Each candidate must maintain fullscreen focus and answer independently throughout the 30-minute timed quiz.
                      </p>
                    </div>
                  </div>
                ...
                <div className="auth-guidelines-checklist">
                  ...
                  <div className="auth-checklist-item">
                    <span style={{ color: '#4ADE80' }}>✓</span> 1 - 2 Members Strictly
                  </div>
                  <div className="auth-checklist-item">
            ...
            <div style={{ marginTop: '24px', paddingTop: '18px', borderTop: '1px solid rgba(56, 189, 248, 0.25)', display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: '0.84rem', color: 'var(--text-primary)', fontStyle: 'italic', marginTop: '2px' }}>
                  "Pick teammates who know their AI artifacts! Solo or Duo — maximum effort!"
                </div>
              </div>
            </div>
          </div>
              ...
              <form onSubmit={handleRegister}>
                ...
                <div style={{ marginBottom: '16px' }}>
                  ...
                  <div className="squad-size-grid">
                    {[
                      { size: '1', title: '1 Member', sub: 'Solo Operative', icon: '👤' },
                ...
                <div style={{ marginBottom: '22px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: `repeat(${Math.min(parseInt(formData.teamSize) || 1, 2)}, 1fr)`, gap: '10px' }}>
                    {[...Array(Math.min(parseInt(formData.teamSize) || 1, 2))].map((_, idx) => {
                      const slot = idx + 1
                      return (
                        <div key={slot} style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(56, 189, 248, 0.25)', borderRadius: '8px', padding: '10px' }}>
                          <div style={{ fontSize: '0.68rem', color: '#38BDF8', fontWeight: 800, textTransform: 'uppercase', marginBottom: '4px' }}>
                            {slot === 1 ? (formData.teamSize === '1' ? '👤 Solo Player' : '👑 Team Lead') : `Member 0${slot}`}
                          </div>
                          <input
                            type="text"
                            placeholder={`Teammate 0${slot} Name`}
